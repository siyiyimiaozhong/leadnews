package com.siyi.crawler.utils;

import com.siyi.crawler.factory.CrawlerProxyFactory;
import com.siyi.model.crawler.core.callback.DelayedCallBack;
import com.siyi.model.crawler.core.cookie.CrawlerCookie;
import com.siyi.model.crawler.core.cookie.CrawlerHtml;
import com.siyi.model.crawler.core.delayed.DelayedUtils;
...
public class SeleniumClient {
    ...
    private SeleniumDriver initChromeDriver(Proxy proxy) {
        ...
        ChromeDriverService chromeDriverService = new ChromeDriverService.Builder()
                .usingDriverExecutable(new File(resourceBundle.getString("webdriver.chrome.driver"))).usingAnyFreePort().build();
