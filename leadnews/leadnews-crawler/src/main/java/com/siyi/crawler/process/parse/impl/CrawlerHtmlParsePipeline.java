package com.siyi.crawler.process.parse.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.siyi.common.common.util.CommonStringUtils;
import com.siyi.common.kafka.KafkaSender;
import com.siyi.common.kafka.messages.SubmitArticleAuthMessage;
import com.siyi.crawler.process.parse.AbstractHtmlParsePipeline;
import com.siyi.crawler.process.thread.CrawlerThreadPool;
import com.siyi.crawler.service.AdLabelService;
import com.siyi.crawler.service.CrawlerNewsAdditionalService;
import com.siyi.crawler.service.CrawlerNewsCommentService;
import com.siyi.crawler.service.CrawlerNewsService;
import com.siyi.crawler.utils.DateUtils;
import com.siyi.crawler.utils.HtmlParser;
import com.siyi.model.crawler.core.label.HtmlLabel;
...
import com.siyi.model.crawler.pojos.ClNewsAdditional;
    ...
    private List<ClNewsComment> analysisCommentJsonData(String jsonData) {
        ...
        if(null != jsonArray){
            ...
            for (Map<String,Object> dataInfo : dataInfoList) {
                ...
                comment.setContent(CommonStringUtils.toString(infoMap.get("Content")));
                comment.setUsername(CommonStringUtils.toString(infoMap.get("UserName")));
                Date date = DateUtils.stringToDate(CommonStringUtils.toString(infoMap.get("PostTime")));
...
//    private String csdnCommentUrl;
    ...
    private ClNews addClNewsData(CrawlerParseItem parseItem) {
        ...
        if(null != parseItem){
            ...
            String[] split = parseItem.getUrl().split("/");
            parseItem.setId(split[split.length - 1]);
    ...
    private ClNews toClNews(CrawlerParseItem parseItem) {
        ...
        clNews.setUrl(parseItem.getUrl());
...
//        String readCount = CommonStringUtils.toString(itemsAll.get("readCount"));
