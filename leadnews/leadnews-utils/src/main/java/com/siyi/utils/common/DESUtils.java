...
public class DESUtils {
    ...
    public static void main(String[] args) {
        ...
        java.lang.String s = new String(hexStringToByte(decode("159CF72C0BD2A8183D536215768C2E91556D77642F214E34")));
        System.out.println(s);

        String password="123456";
        System.out.println(password);
        password = Base64Utils.encode(DESUtils.encode(password).getBytes());
        System.out.println(password);
        System.out.println(new String(hexStringToByte(DESUtils.decode(new String(Base64Utils.decode(password))))));
    }
}